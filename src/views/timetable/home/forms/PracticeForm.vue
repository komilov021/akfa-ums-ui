...
import { ICreatePracticeCalendar } from "@/models/backend";
import {
...
const ruleForm = reactive<ICreatePracticeCalendar>({
  name: "",
  description: "",
  room_id: "",
  date: "",
    ...
    if (valid) {
      try {
        ...
        const data = {
          ...
          date: ruleForm.date === "" ? undefined : ruleForm.date,
        };
        await calendarStore.createPracticeCalendar(data);
