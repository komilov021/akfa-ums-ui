<template>
  <div class="grid md:grid-cols-2 h-full">
    <div class="space-y-3 px-4 md:px-24 pt-4 md:pt-6 h-full relative m-auto">
      <div class="header flex flex-col items-center space-y-3 md:space-y-3">
        <LogoIconWithName />
        <h1 class="header__title">Sign up</h1>
        <p class="text-tertiary-600">Become part of our family</p>
      </div>
      <el-form
        ref="ruleFormRef"
        :model="ruleForm"
      ...
      >
        ...
        <el-form-item label="Email" prop="last_name">
          <el-input
        ...
        <el-form-item label="Mobile Phone" prop="email">
          <el-input
        ...
        <!-- <el-form-item label="Choose university" prop="password">
            <el-input
        ...
        <p class="text-secondary-700 font-semibold text-sm tracking-tighter">
          Choose university
        </p>
        <el-select
        ...
        <el-form-item label="Role" prop="confirm_password">
          <el-input
    ...
    <div class="relative w-full h-full hidden md:flex items-center">
      <picture>
        <source
          type="image/avif"
          srcset="@/assets/images/loginView/signup-small.avif"
          media="(max-width: 800px)"
        />
        <source
          type="image/avif"
          srcset="@/assets/images/loginView/signup-normal.avif"
          media="(max-width: 800px)"
        />
        <img
          src="@/assets/images/signup-login.png"
          class="w-screen h-screen rounded-l-3xl"
          alt=""
        />
      </picture>
    </div>
