<template>
  <div>
    <el-button size="large" type="primary" class="mt-8" @click="downloadFile">
      View template
    </el-button>
...
const downloadFile = async () => {
  const fileUrl = new URL("@/assets/finance-module.xlsx", import.meta.url).href;
  const fileName = "payment-finance-template.xlsx";
  saveFile(fileUrl as any, fileName, true);
};
